...
<script src="https://cdn.tiny.cloud/1/a2m45axcg7teehvux8n74tagjp7ncux8ltaoggkrw089zof3/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
...
<div class="container">
	<div id="contents">
		<form action="${actionUrl}" method="post" id="frm" name="frm" onsubmit="retrun regist()" enctype="multipart/form-data">
