...
<c:url var="sellUrl" value="/sell">
  ...
  <main id="main" class="min">
        ...
        <div class="row">
          ...
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-body">
              <div id="card_titles">
                <p id="com_name"><a href="/list?keyword=${comName}"><strong>${comName}</strong></a></p>
                <p class="card-title">${pvo.pCode}</p>
                <p class="pNameWrite">${pvo.pName}</p>
              </div>
                <div>
                ...
                <div class="likeBtn d-grid gap-1">
                	<button type="button" class="btn btn-light btn-lg">
					    ...
					    <span class="bookmark likeUnActive">
	...
	<hr>
        ...
        <div id="review_title_form">
          <p id="review_title">Review</p>
