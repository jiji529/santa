...
<body>
        ...
        <div class="join-page">
            <div class="join-content">
                ...
                <form id="agreeFrm" method="POST" class="wrapper-box">
                    ...
                    <button type="button" class="btn1" id="signup">회원가입</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div id="modal2" class="modal">
        <div class="modal-content">
            ...
            <h3>개인정보 처리 방침</h3>
            <p>개인정보처리방침 | SANTA
                산타㈜(이하 회사)는 ｢개인정보 보호법｣ 에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립 및
                공개합니다.
